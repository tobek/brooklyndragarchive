...
<?php
				...
				if (($messageNo == '') || ($messageNo == '2') || ($messageNo == '4')){
					...
					echo '<form enctype="multipart/form-data" method="post" id="recover_password" class="user-forms" action="'.add_query_arg( 'submitted', 'yes', wppb_curpageurl() ).'">';
						...
						// CHANGED BY TOBY to just email
						$recoverPasswordFilterArray['notification'] = __('Please enter your email address.', 'profilebuilder').'<br/>'.__('You will receive a link to create a new password via email.', 'profilebuilder').'<br/><br/>';
						...
						$recoverPasswordFilterArray['input'] = '
							<p class="username_email">
								<label for="username_email">'. __('Email', 'profilebuilder').'</label>
