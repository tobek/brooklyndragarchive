...
<?php
				...
				if ($wppb_defaultOptions['nickname'] == 'show'){
					...
					// CHANGED BY TOBY Nickname to Username
				...
				if ($wppb_defaultOptions['bio'] == 'show'){
					...
					// CHANGED BY TOBY from "Biographical Info"
					$editProfileFilterArray2['aboutYourself2'] = '
						<p class="form-description'.$errorVar.'">
							<label for="description">'. apply_filters('bda_wppb_about_you', 'About You') .$errorMark.'</label>
